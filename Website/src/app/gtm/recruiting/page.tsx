    ...
    >
      ...
      >
        <div ref={bodyRef} style={{ padding: "0 24px 24px 64px" }}>
          ...
          {layer.id === 7 &&
            layer.sections[0]?.body.includes("Handshake") && (
              <ComparisonTable />
            )}
        </div>
      </div>
    ...
    <div data-solution="recruiting">
      ...
      >
        ...
        >
          <div>
            ...
            >
              SOLUTION 02 — TECHNICAL RECRUITING
            </p>
            <h1
              style={{
                fontSize: 32,
      ...
      {activeTab === "builder" ? (
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 48px 80px" }}>
          <ContentLibrary solution="recruiting" solutionLabel="Technical Recruiting" />
        </div>
      ) : (
        <div
          style={{
        ...
        >
            ...
            <CustomerJourneyMap solution="recruiting" solutionLabel="Technical Recruiting" />
