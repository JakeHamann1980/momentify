    ...
    >
      ...
      >
        <div ref={bodyRef} style={{ padding: "0 24px 24px 64px" }}>
          ...
          {layer.id === 7 &&
            layer.sections[0]?.body.includes("StellarAlgo") && (
              <ComparisonTable />
            )}
        </div>
      </div>
...
function EventsVenuesContent() {
  ...
  return (
    <div data-solution="events-venues">
      {/* ── Page Header ── */}
      <div
        style={{
          maxWidth: 1200,
      ...
      >
        ...
        >
          <div>
            ...
            >
              Fan engagement. Suite intelligence. Venue-wide ROX.
            </p>
          </div>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            <StatChip label="2 Motions" />
            <StatChip label="1 Vertical (Primary)" />
      ...
      {activeTab === "builder" ? (
        ...
        >
            ...
            <CustomerJourneyMap solution="events-venues" solutionLabel="Events & Venues" />
