    ...
    >
      ...
      >
        <div ref={bodyRef} style={{ padding: "0 24px 24px 64px" }}>
          ...
          {layer.id === 7 &&
            layer.sections[0]?.body.includes("Showpad") && (
              <ComparisonTable />
            )}
        </div>
      </div>
    ...
    <div data-solution="field-sales">
      ...
      >
        ...
        >
          <div>
            ...
            >
              SOLUTION 03 — FIELD SALES ENABLEMENT
            </p>
            <h1
              style={{
                fontSize: 32,
      ...
      {activeTab === "builder" ? (
        ...
        >
            ...
            <CustomerJourneyMap solution="field-sales" solutionLabel="Field Sales Enablement" />
