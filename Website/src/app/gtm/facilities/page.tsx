    ...
    >
      ...
      >
        <div ref={bodyRef} style={{ padding: "0 24px 24px 64px" }}>
          ...
          {layer.id === 7 &&
            layer.sections[0]?.body.includes("Digital Signage") && (
              <ComparisonTable />
            )}
        </div>
      </div>
    ...
    <div data-solution="facilities">
      ...
      >
        ...
        >
          <div>
            ...
            >
              Showrooms. Demo floors. Training centers. One intelligence layer.
            </p>
          </div>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            <StatChip label="2 Motions" />
            <StatChip label="2 Verticals" />
      ...
      {activeTab === "builder" ? (
        ...
        >
            ...
            <CustomerJourneyMap solution="facilities" solutionLabel="Facilities" />
