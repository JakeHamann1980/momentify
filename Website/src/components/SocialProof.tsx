...
const outcomes = [
  {
    ...
    link: "/case-studies/distributech",
  },
  {
  ...
  },
  {
    ...
    link: "/case-studies/global-dealer-learning",
  },
];
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-12">
        ...
        >
          <a
            href="/case-studies"
            className="inline-flex items-center justify-center gap-2 text-[13px] sm:text-[14px] py-3 sm:py-3.5 px-7 sm:px-9 transition-all duration-200 hover:opacity-90 hover:-translate-y-0.5"
            style={{
              fontFamily: "var(--font-inter)",
              fontWeight: 600,
              color: "#061341",
              ...
              borderRadius: "8px",
              border: "1.5px solid rgba(6, 19, 65, 0.15)",
              letterSpacing: "-0.01em",
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.borderColor = "rgba(6, 19, 65, 0.35)";
            }}
            onMouseLeave={(e) => {
