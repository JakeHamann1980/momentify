    ...
    <ul style={{ marginBottom: "16px", paddingLeft: "0" }}>
      {items.map((item, i) => (
        <li key={i} className="flex items-start gap-2.5" style={{ marginBottom: "8px" }}>
          <span className="mt-[8px] h-[5px] w-[5px] rounded-full flex-shrink-0" style={{ backgroundColor: "#00BBA5" }} />
...
function Caps({ children }: { children: React.ReactNode }) {
  return (
    <p style={{ fontFamily: "var(--font-inter)", fontWeight: 400, fontSize: "15px", color: BODY_COLOR, lineHeight: 1.7, marginBottom: "16px", textTransform: "uppercase" as const }}>
      {children}
    </p>
  );
}
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12 flex items-center" style={{ minHeight: "440px" }}>
            <div>
              ...
              >
                Please read these terms carefully before using the Momentify platform and services operated by ENTEVATE, INC.
              </motion.p>
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: "80px 0" }}>
          <div className="mx-auto max-w-4xl px-6 lg:px-12">
            <P>
              Please read these Terms of Service carefully before using the Services operated by ENTEVATE, INC.
              (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), a company registered in Texas, United States,
              at 5 Cowboys Way, Frisco, TX 75034.
            </P>
            <P>
              We operate the website <a href="https://www.momentifyapp.com" className="underline hover:opacity-70" style={{ color: "#00BBA5" }}>https://www.momentifyapp.com</a>,
              as well as the Momentify mobile application (the &quot;App&quot;), and any other related products and services
              that refer or link to these legal terms (collectively, the &quot;Services&quot;).
            </P>
            <P>
              By accessing or using our Services, you agree to be bound by these Legal Terms. If you do not agree with
              all of these Legal Terms, you are expressly prohibited from using the Services and you must discontinue use immediately.
            </P>
            ...
            <Section id="intellectual-property" title="2. Intellectual Property Rights">
              ...
              <P>
                ...
                rights and unfair competition laws) and treaties in the United States and around the world. The Content and
                Marks are provided in or through the Services &quot;AS IS&quot; for your internal business purpose only.
              </P>
              ...
              <P>
                ...
                we grant you a non-exclusive, non-transferable, revocable license to: access the Services; and download or
                print a copy of any portion of the Content to which you have properly gained access, solely for your internal
                business purpose.
              </P>
              <P>
              ...
              <P>
                ...
                elsewhere in our Legal Terms, please address your request to: <a href="mailto:hello@entevate.com" className="underline hover:opacity-70" style={{ color: "#00BBA5" }}>hello@entevate.com</a>.
                If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content,
                you must identify us as the owners or licensors of the Services, Content, or Marks.
              </P>
              <P>
                We reserve all rights not expressly granted to you in and to the Services, Content, and Marks. Any breach
                of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to
                use our Services will terminate immediately.
              </P>

              <SubHead>Your submissions and contributions</SubHead>
              <P>
              ...
              <P>
                <strong>When you post Contributions, you grant us a license:</strong> By posting any Contributions, you
                grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free,
                fully-paid, worldwide right, and license to: use, copy, reproduce, distribute, sell, resell, publish,
                broadcast, retitle, store, publicly perform, publicly display, reformat, translate, excerpt (in whole or
                in part), and exploit your Contributions for any purpose, commercial, advertising, or otherwise, to prepare
              ...
              <P>
                ...
                Contributions through any part of the Services you confirm that you have read and agree with our
                &quot;Prohibited Activities&quot; and will not post, send, publish, upload, or transmit through the Services
                any content that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive,
                discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful,
                or misleading. You are solely responsible for your Submissions and/or Contributions and you expressly
                agree to reimburse us for any and all losses that we may suffer because of your breach of this section,
            ...
            <Section id="user-representations" title="3. User Representations">
              <P>
                ...
                promptly update such registration information as necessary; (3) you have the legal capacity and you agree
                to comply with these Legal Terms; (4) you are not a minor in the jurisdiction in which you reside; (5) you
            ...
            {/* 5 */}
            <Section id="purchases-payment" title="5. Purchases and Payment">
              <P>
            ...
            <Section id="subscriptions" title="6. Subscriptions">
              <SubHead>Billing and Renewal</SubHead>
              <P>
                ...
                such time as you cancel the applicable order. The length of your billing cycle is annual.
              </P>
              ...
              <P>
                ...
                please email us at <a href="mailto:hello@entevate.com" className="underline hover:opacity-70" style={{ color: "#00BBA5" }}>hello@entevate.com</a>.
              </P>
              <SubHead>Fee Changes</SubHead>
              <P>
            ...
            {/* 7 */}
            <Section id="software" title="7. Software">
              <P>
              ...
              <P>
                Any software and any related documentation is provided &quot;AS IS&quot; without warranty of any kind, either
                express or implied, including, without limitation, the implied warranties of merchantability, fitness for a
                particular purpose, or non-infringement. You accept any and all risk arising out of use or performance of
                any software. You may not reproduce or redistribute any software except in accordance with the EULA or
                these Legal Terms.
              </P>
            </Section>
            ...
            {/* 9 */}
            <Section id="user-generated-contributions" title="9. User Generated Contributions">
              <P>
            ...
            {/* 11 */}
            <Section id="mobile-application" title="11. Mobile Application License">
              <SubHead>Use License</SubHead>
              <P>
                ...
                applicable law, decompile, reverse engineer, disassemble, attempt to derive the source code of, or decrypt
                the App; (2) make any modification, adaptation, improvement, enhancement, translation, or derivative work
                from the App; (3) violate any applicable laws, rules, or regulations in connection with your access or use
                of the App; (4) remove, alter, or obscure any proprietary notice (including any notice of copyright or
                trademark) posted by us or the licensors of the App; (5) use the App for any revenue-generating endeavor,
                commercial enterprise, or other purpose for which it is not designed or intended; (6) make the App available
                over a network or other environment permitting access or use by multiple devices or users at the same time;
                (7) use the App for creating a product, service, or software that is, directly or indirectly, competitive
                with or in any way a substitute for the App; (8) use the App to send automated queries to any website or to
                send any unsolicited commercial email; or (9) use any proprietary information or any of our interfaces or
              ...
              <SubHead>Apple and Android Devices</SubHead>
              <P>
                The following terms apply when you use the App obtained from either the Apple Store or Google Play (each an
                &quot;App Distributor&quot;) to access the Services: (1) the license granted to you for our App is limited
                to a non-transferable license to use the application on a device that utilizes the Apple iOS or Android
                ...
                license contained in these Legal Terms or as otherwise required under applicable law, and you acknowledge
                that each App Distributor has no obligation whatsoever to furnish any maintenance and support services with
                ...
                must comply with applicable third-party terms of agreement when using the App; and (6) you acknowledge and
            ...
            {/* 12 */}
            <Section id="services-management" title="12. Services Management">
              <P>
            ...
            {/* 13 */}
            <Section id="privacy-policy" title="13. Privacy Policy">
              <P>
                We care about data privacy and security. Please review our Privacy Policy:{" "}
                <a href="/privacy" className="underline hover:opacity-70" style={{ color: "#00BBA5" }}>https://www.momentifyapp.com/privacy</a>.
            ...
            {/* 14 */}
            <Section id="term-termination" title="14. Term and Termination">
              <P>
            ...
            <Section id="governing-law" title="16. Governing Law">
              <P>
                ...
                the State of Texas applicable to agreements made and to be entirely performed within the State of Texas,
            ...
            <Section id="dispute-resolution" title="17. Dispute Resolution">
              <SubHead>Informal Negotiations</SubHead>
              <P>
              ...
              <P>
                ...
                for Consumer Related Disputes (&quot;AAA Consumer Rules&quot;), both of which are available at the American
                Arbitration Association (AAA) website. Your arbitration fees and your share of arbitrator compensation shall
                be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The
                ...
                arbitration will take place in Texas.
              </P>
              <P>
                ...
                to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction, and
                the Parties agree to submit to the personal jurisdiction of that court.
              </P>

              <SubHead>Restrictions</SubHead>
              <P>
              ...
              <SubHead>Exceptions to Informal Negotiations and Arbitration</SubHead>
              <P>
                ...
                and such Dispute shall be decided by a court of competent jurisdiction, and the Parties agree to submit to
            ...
            <Section id="disclaimer" title="19. Disclaimer">
              <P>
                ...
                VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY,
            ...
            {/* 20 */}
            <Section id="limitations-liability" title="20. Limitations of Liability">
              <P>
            ...
            {/* 22 */}
            <Section id="user-data" title="22. User Data">
              <P>
            ...
            {/* 23 */}
            <Section id="electronic-communications" title="23. Electronic Communications, Transactions, and Signatures">
              <P>
            ...
            {/* 24 */}
            <Section id="california-users" title="24. California Users and Residents">
              <P>
            ...
            {/* 25 */}
            <Section id="miscellaneous" title="25. Miscellaneous">
              <P>
            ...
            {/* 26 */}
            <Section id="contact-us" title="26. Contact Us">
              <P>
              ...
              <div style={{ fontFamily: "var(--font-inter)", fontWeight: 400, fontSize: "15px", color: BODY_COLOR, lineHeight: 1.7 }}>
                ...
                <p style={{ marginBottom: "4px" }}>5 Cowboys Way</p>
                <p style={{ marginBottom: "4px" }}>Frisco, TX 75034</p>
                <p style={{ marginBottom: "4px" }}>United States</p>
                <p style={{ marginBottom: "4px" }}>Phone: <a href="tel:19722003445" className="underline hover:opacity-70" style={{ color: "#00BBA5" }}>1 (972) 200-3445</a></p>
                <p><a href="mailto:hello@entevate.com" className="underline hover:opacity-70" style={{ color: "#00BBA5" }}>hello@entevate.com</a></p>
              </div>
            </Section>
          </div>
        </section>
